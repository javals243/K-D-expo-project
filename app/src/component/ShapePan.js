...
export default class Shape extends Component {
  ...
  constructor(props){
    ...
    this.state={
      ...
      dataPath: this.props.paint === "Animals" ? this.props.paintStore.getPointStoreAnimals(this.props.data.number, this.props.name):this.props.paintStore.getPointStoreObjects(this.props.data.number, this.props.name)
    };
  ...
  _Release(e, data, dataPath)
    {
      if(this.props.isPaint)
      {
        if (this.props.paint === "Animals")
        {
          this.props.paintStore.addPointAnimals({color:this.props.paintStore.color, data: dataPath.path, strokeWidth: this.props.paintStore.strokeColor}, data.number, this.props.name);
          this.props.paintStore.resetPathAnimals( data.number, this.props.name);
        }
        else if (this.props.paint === "Objects")
        {
          this.props.paintStore.addPointObjects({color:this.props.paintStore.color, data: dataPath.path, strokeWidth: this.props.paintStore.strokeColor }, data.number, this.props.name);
        ...
        <G  {...this._panResponder.panHandlers} >
          <Defs>
           ...
           <G clipPath={"url(#clip" + data.number + ")"}>
            ...
            <PathOld listData={dataPath.listData} numberPath={numberPath} strokeWidth={this.props.paintStore.strokeColor} onRef={ref => (this._refData = ref)}/>
            <Path
                d={dataPath.path}
                fill="none"
