...
export default class ItemTutorial extends Component {
    ...
    renderLine = () => {
        ...
        return (
            <View style={styles.view_line}>         
                <Image style={{resizeMode: "center", width: sizeWidth(300)}} source={require("../../../res/images_paint/onB/line_4x_1.png")}/>
            </View>
        )
    }
    ...
    renderImage = () => {
        ...
        return (
            <View style={styles.view_header}>         
                <View style={[styles.view_img, {backgroundColor: data.backgroundColor}]}>
    ...
    renderButton = () => {
        ...
        let button = (data.id == 0 || data.id == 3) 
        ? <Button onPress={onPressNext} style={styles.button_one} text={data.button} />
        : <View style={styles.button_two}>
            <IconCircleButton onPress={onPressPrev} style={styles.button_prev}  backgroundColor={"#8871FF"} source={require("../../../res/images_paint/buttons/arrow_back.png")}/>
            <Image style={{resizeMode: "center", width: sizeWidth(25)}}  source={data.dot}/>
            <Button onPress={onPressNext} style={styles.button_next} textStyle={{fontSize: sizeFont(4.5)}} text={data.button} />
          </View> 
        return (
