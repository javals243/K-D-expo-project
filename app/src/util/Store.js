...
export const saveAlphabet = (alphabets) => AsyncStorage.setItem(LEARNED_ALPHABETS, JSON.stringify(alphabets));
export const saveNumbers = (numbers) => AsyncStorage.setItem(LEARNED_ALPHABETS, JSON.stringify(numbers));
